...
namespace Prackticka
{
    public partial class Form2 : Form
    {
        ...
        private string sqlConnectionStr = ConfigurationManager.ConnectionStrings["DB"].ConnectionString.Replace("%PathToDb%", Path.GetFullPath("DB.mdf"));
        ...
        {
            sqlConnection1 = new SqlConnection(sqlConnectionStr);
            sqlConnection1.Open();
